...
class Student:
    def __init__(self,root):
        ...
        m_title=Label(Manage_Frame,text="Manage Students",bg="white",font=("times new roman",30,"bold"))
        m_title.grid(row=0,columnspan=2,pady=20)

        lbl_roll=Label(Manage_Frame,text="Roll",bg="red",fg="white",font=("times new roman",20,"bold"))
        ...
        lbl_Contact=Label(Manage_Frame,text="Conatact",bg="red",fg="white",font=("times new roman",20,"bold"))
